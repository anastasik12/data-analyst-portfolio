...
**Файлы:**
- [Схема БД (schema.sql)](sql/schema.sql)
- [Аналитические запросы](sql/queries.sql) – если такой файл есть (создай отдельно, если нет)
- [ER-диаграмма](sql/er_diagram.png) – укажи правильное имя файла (physical_diagram.png или conceptual_diagram.png)
